...
func (_mock *MockRepository) GetByID(ctx context.Context, id assetsource.ID) (*assetsource.AssetSource, error) {
	...
	var r0 *assetsource.AssetSource
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, assetsource.ID) (*assetsource.AssetSource, error)); ok {
		return returnFunc(ctx, id)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, assetsource.ID) *assetsource.AssetSource); ok {
		r0 = returnFunc(ctx, id)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*assetsource.AssetSource)
		}
	}
	if returnFunc, ok := ret.Get(1).(func(context.Context, assetsource.ID) error); ok {
...
func (_c *MockRepository_GetByID_Call) Run(run func(ctx context.Context, id assetsource.ID)) *MockRepository_GetByID_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
		}
		var arg1 assetsource.ID
		if args[1] != nil {
			arg1 = args[1].(assetsource.ID)
		}
		run(
			arg0,
			arg1,
...
func (_c *MockRepository_GetByID_Call) Return(assetSource *assetsource.AssetSource, err error) *MockRepository_GetByID_Call {
	_c.Call.Return(assetSource, err)
	return _c
}

func (_c *MockRepository_GetByID_Call) RunAndReturn(run func(ctx context.Context, id assetsource.ID) (*assetsource.AssetSource, error)) *MockRepository_GetByID_Call {
	_c.Call.Return(run)
	return _c
}
